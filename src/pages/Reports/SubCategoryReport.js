...
const SubCategoryReport = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await reportsAPI.getSubCategoryWiseReport({
            ...
            console.error('Error fetching subcategory report:', error);
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div style={{ padding: '24px' }}>
            <div style={{ marginBottom: 24 }}>
                <Title level={2}>Subcategory Wise Sales Report</Title>
                <Text type="secondary">
                    Detailed breakdown of sales performance by subcategory (Server Aggregated).
                </Text>
            </div>
            ...
            {categoryData.length > 0 ? (
                <Row gutter={[24, 24]} style={{ marginTop: 24 }}>
                    ...
                    <Col xs={24} lg={12}>
                        <Card title="Revenue by Subcategory (Bar Chart)" style={{ height: '100%' }}>
                            <div style={{ width: '100%', height: 350 }}>
                                <ResponsiveContainer>
                                    <BarChart
                                        data={categoryData}
